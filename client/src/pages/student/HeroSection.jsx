    ...
    <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-200 dark:text-gray-400 mb-8">
          Discover, Lean, and Upskill with our wide range of course
        </p>
        ...
        >
          ...
          <Button
            className={
              "bg-blue-600 dark:bg-gray-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700 dark:hover:bg-blue-800"
            }
          >
            Search
          </Button>
